...
void Riverdi_calibrate(void);
void Riverdi_getTouch(int *yposition, int *xposition);
void Riverdi_write_image(uint16_t image[] );
void Riverdi_inc_cmdoffset(uint16_t increment);
void Riverdi_start_cmd(uint32_t command);
void draw_Desserts(void);
//void draw_Drink(void);
...
void Riverdi_WaitForTouch(void);
...
#define TOUCH_DETECTED_MASK 0x02
...
#define MEM_W RITE	0x80	/* FT8xx Host Memory Write */
